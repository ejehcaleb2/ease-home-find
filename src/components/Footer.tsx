        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">HomeEase</span>
            </div>
            <p className="text-gray-400 text-sm">
              Connecting Nigerians to verified, affordable rental homes without the stress of agent fees.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <p className="text-gray-400">support@homeease.ng</p>
            </div>
          </div>
        </div>
